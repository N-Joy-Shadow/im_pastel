...
export interface IEtcButtonProps {
  href: string;
  name: string
  primary_color: string
  secondary_color: string
...
xl:mx-2 xl:hover:border-white xl:hover:text-white  xl:text-[${props.primary_color}] xl:hover:bg-[${props.secondary_color}] xl:hover:cursor-pointer `
  return (
