            ...
            <div className='flex justify-center flex-wrap my-[2.25rem]'>
                ...
                >
                    ...
                    <div className="flex inherit justify-center items-center text-center mx-auto w-[400px] xl:w-[560px] top-[77px]">
                        ...
                        <iframe className="m-8 h-[300px] xl:h-[378px]" src="https://player.twitch.tv/?channel=rkdwl12&parent=pastel.im" height="378" width="620" allowFullScreen={true}></iframe>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex inherit justify-center items-center text-center mx-auto w-[400px] xl:w-[560px] top-[77px]">
                        ...
                        <iframe className="m-8 h-[300px] xl:h-[378px] " src="https://player.twitch.tv/?channel=arahashitabi_stellive&parent=pastel.im" height="378" width="620" allowFullScreen={true}></iframe>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex inherit justify-center items-center text-center mx-auto w-[400px] xl:w-[560px] top-[77px]">
                        ...
                        <iframe className="m-8 h-[300px] xl:h-[378px] " src="https://player.twitch.tv/?channel=akanelize_stellive&parent=pastel.im" height="378" width="620" allowFullScreen={true}></iframe>
                    </div>
                </div>
                ...
                >
                    ...
                    <div className="flex inherit justify-center items-center text-center mx-auto w-[400px] xl:w-[560px] top-[77px]">
                        ...
                        <iframe className="m-8 h-[300px] xl:h-[378px] " src="https://player.twitch.tv/?channel=shirayukihina_stellive&parent=pastel.im" height="378" width="620" allowFullScreen={true}></iframe>
                    </div>
                </div>
