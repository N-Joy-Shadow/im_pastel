                ...
                >
                    ...
                    <div className="article-body block xl:flex-none inherit justify-center text-center mt-[70px] xl:mt-0 xl:top-[97px]">
                        ...
                        <div className="xl:mx-auto xl:h-[315px]">
                            <iframe className="m-auto w-[300px] xl:w-[560px] xl:px-0" width="560" height="315" src="https://www.youtube-nocookie.com/embed/kPdB6iGYBBc" title="YouTube video player" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowFullScreen></iframe>
                        </div>
                    </div>
                </div>
            </div>
